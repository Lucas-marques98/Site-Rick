          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <motion.a
                ...
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-gradient-to-tr hover:from-yellow-500 hover:via-red-500 hover:to-purple-500 hover:text-white transition-colors duration-300"
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                transition={{ type: "spring", stiffness: 400 }}
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-green-500 hover:text-white transition-colors duration-300"
                aria-label="WhatsApp"
              >

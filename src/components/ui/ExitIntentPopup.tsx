          ...
          >
            ...
            <div className="text-center">
              ...
              <a 
                ...
                onClick={() => setIsVisible(false)}
                className="w-full flex items-center justify-center p-4 bg-primary text-white rounded-lg hover:bg-slate-800 transition-colors shadow-lg font-medium text-lg"
              >
